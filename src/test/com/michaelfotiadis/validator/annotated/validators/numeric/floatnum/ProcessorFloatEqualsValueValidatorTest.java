 ...
 *
 */
public class ProcessorFloatEqualsValueValidatorTest {
    ...
    private static final class TestFloatItemValid {
        @FloatEqualsValue(value = 7.34f, epsilon = EPSILON)
        private static final float valid = 7.34f;
    }

    @SuppressWarnings("unused")
    private static final class TestFloatItemInvalid {
        @FloatEqualsValue(value = 7.3f, epsilon = EPSILON)
        private static final float invalid = 3f;
    }

    @SuppressWarnings("unused")
    private static final class TestFloatItemValidInvalid {
        @FloatEqualsValue(value = -0.00000000000000000001f, epsilon = EPSILON)
        private static final Float valid = -0.00000000000000000001f;
        @FloatEqualsValue(value = 7f, epsilon = EPSILON)
    ...
    private static final class TestFloatItemValidDeepInvalid {
        ...
        @FloatEqualsValue(value = 65654.4343112312f, epsilon = EPSILON)
