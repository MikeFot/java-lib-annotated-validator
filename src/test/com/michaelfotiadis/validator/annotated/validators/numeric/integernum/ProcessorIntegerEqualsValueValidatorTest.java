 ...
 *
 */
public class ProcessorIntegerEqualsValueValidatorTest {
    ...
    private static final class TestIntegerItemValidInvalid {
        @IntegerEqualsValue(Integer.MAX_VALUE)
        private static final Integer valid = Integer.MAX_VALUE;
        @IntegerEqualsValue(7)
